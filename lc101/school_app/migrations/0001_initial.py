# Generated by Django 2.0.2 on 2018-06-13 10:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='belong_in_department', to='school_app.Department')),
            ],
        ),
        migrations.CreateModel(
            name='Teacher',
        ...
        migrations.AddField(
            model_name='classroom',
            name='subject',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subject_in_classroom', to='school_app.Subject'),
        ),
        migrations.AddField(
            model_name='classroom',
            name='teacher',
